...
import { ArrowRight, ArrowRightCircle, Github, Instagram, Linkedin, Twitter } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <SoundManager>
      <div className="min-h-screen relative overflow-hidden font-mono text-[#594c3d] scanlines pixel-grid">
        {/* Overlay for better text readability */}
        <div className="absolute inset-0 bg-[#e1dac5]/70" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center">
          ...
          <div className="mb-16 float-animation">
            <h1 className="text-8xl font-bold text-[#594c3d] mb-4 tracking-wider drop-shadow-lg">VICTOR TORRES</h1>
            ...
            <p className="text-2xl text-[#594c3d] font-medium tracking-wide opacity-80">
              AQUI VOCÊ ENCONTRARÁ MEUS PROJETOS, HABILIDADES, CONTATOS E GUIAS TUDO DE UM JEITO DIVERTIDO E INTERATIVO!
            </p>
          </div>
            ...
            <Link href="/home">
              ...
              >
                <div className="flex gap-3">
                  BORA LÁ? <ArrowRightCircle className="w-6 h-6 mt-1" />
                </div>
              </PixelatedButton>
            </Link>
          </div>
